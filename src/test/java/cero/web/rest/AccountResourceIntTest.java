...
import cero.CeroApp;
import cero.domain.Authority;
import cero.domain.User;
import cero.repository.AuthorityRepository;
...
import cero.web.rest.errors.ExceptionTranslator;
import cero.web.rest.vm.KeyAndPasswordVM;
import cero.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = CeroApp.class)
