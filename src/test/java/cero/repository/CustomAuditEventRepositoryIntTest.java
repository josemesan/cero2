package cero.repository;

import cero.CeroApp;
import cero.config.Constants;
import cero.config.audit.AuditEventConverter;
import cero.domain.PersistentAuditEvent;
...
import static cero.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
